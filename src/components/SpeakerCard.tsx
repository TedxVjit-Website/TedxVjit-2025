  ...
  return (
    <>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="relative max-w-4xl w-full max-h-[90vh] overflow-hidden rounded-2xl bg-gray-900 border border-gray-700 animate-fade-in-up"
          ...
          >
            ...
            {/* Modal Content */}
            <div className="p-6 md:p-8 max-h-[90vh] overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-red-400 font-semibold mb-1">
                  {speaker.title}
                </p>
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center gap-4">
                  <a
                    ...
                    className="w-12 h-12 bg-red-600/20 hover:bg-red-600/40 rounded-full flex items-center justify-center border border-red-500/30 hover:border-red-400 transition-all duration-300"
                  >
